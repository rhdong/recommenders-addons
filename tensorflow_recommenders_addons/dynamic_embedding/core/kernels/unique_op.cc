...
struct UniqueOpHashMap {
  using map_type = deepx_core::HashMap<T, TIndex>;
};
...
#define REGISTER_UNIQUE(type)                                    \
  REGISTER_KERNEL_BUILDER(Name("TFRAUnique")                     \
                              .Device(DEVICE_CPU)                \
  ...
  REGISTER_KERNEL_BUILDER(Name("TFRAUnique")                     \
                          ...
                          UniqueOp<type, int64>);                \
  REGISTER_KERNEL_BUILDER(Name("TFRAUniqueV2")                   \
                              .Device(DEVICE_CPU)                \
                              .TypeConstraint<type>("T")         \
                              .TypeConstraint<int32>("out_idx"), \
                          UniqueOp<type, int32>);                \
  REGISTER_KERNEL_BUILDER(Name("TFRAUniqueV2")                   \
                              ...
                              .TypeConstraint<int64>("out_idx"), \
                          UniqueOp<type, int64>);                \
  REGISTER_KERNEL_BUILDER(Name("TFRAUniqueWithCounts")           \
                              .Device(DEVICE_CPU)                \
                              .TypeConstraint<type>("T")         \
                              .TypeConstraint<int32>("out_idx"), \
                          UniqueOp<type, int32>)                 \
  REGISTER_KERNEL_BUILDER(Name("TFRAUniqueWithCounts")           \
                              ...
                              .TypeConstraint<int64>("out_idx"), \
                          UniqueOp<type, int64>);                \
  REGISTER_KERNEL_BUILDER(Name("TFRAUniqueWithCountsV2")         \
                              .Device(DEVICE_CPU)                \
                              .TypeConstraint<type>("T")         \
                              .TypeConstraint<int32>("out_idx"), \
                          UniqueOp<type, int32>)                 \
