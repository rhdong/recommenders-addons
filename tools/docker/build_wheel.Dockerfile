...
ENV PATH=/dt9/usr/bin:${PATH}
ENV LD_LIBRARY_PATH=/usr/local/lib:${LD_LIBRARY_PATH}
ENV LD_LIBRARY_PATH=/dt9/user/lib64:${LD_LIBRARY_PATH}
ENV LD_LIBRARY_PATH=/dt9/user/lib:${LD_LIBRARY_PATH}
ENV MANPATH=/dt9/user/share/man:${LD_LIBRARY_PATH}
ENV INFOPATH=/dt9/user/share/info
